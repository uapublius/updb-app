<template>
  ...
  <div v-if="!reportsStore.isSearching && reportsStore.resultsTotal !== null" shadow="never" class="ms-2 pn-2 pw-1">
  ...
  <el-card v-show="!reportsStore.isSearching && reportsStore.resultsTotal !== null" shadow="never" class="ms-3">
    <report-list anchor />
