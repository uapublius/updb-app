      ...
      <div class="flex align-items-center">
        ...
        <client-only>
          <div class="icon-links flex">
            <a class="mw-2 flex align-items-center" @click="copyLink" target="_blank" title="Copy permalink">
              <icon-copy />
              <div v-if="copiedLink">Copied</div>
              <div v-else>Copy link</div>
            </a>

            <a class="mw-2 flex align-items-center" :href="tweetUrl" title="Tweet report" target="_blank">
              <icon name="twitter" />
              <div>Tweet link</div>
            </a>
          </div>
