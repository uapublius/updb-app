...
gunzip -c /tmp/phenomenon.sql.gz | psql phenomenon
...
# this config is for public nginx, dockerized version of UPDB
# should just overwrite the default site
...
# htpasswd -c /etc/nginx/.htpasswd beta
